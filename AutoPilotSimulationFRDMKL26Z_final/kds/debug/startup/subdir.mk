...
C:/Freescale/KSDK_1.3.0/platform/devices/MKL26Z4/startup/system_MKL26Z4.c 

S_UPPER_SRCS += \
C:/Freescale/KSDK_1.3.0/platform/devices/MKL26Z4/startup/gcc/startup_MKL26Z4.S 

OBJS += \
./startup/startup.o \
./startup/startup_MKL26Z4.o \
./startup/system_MKL26Z4.o 

C_DEPS += \
./startup/startup.d \
./startup/system_MKL26Z4.d 
...
startup/startup_MKL26Z4.o: C:/Freescale/KSDK_1.3.0/platform/devices/MKL26Z4/startup/gcc/startup_MKL26Z4.S
	@echo 'Building file: $<'
...
startup/system_MKL26Z4.o: C:/Freescale/KSDK_1.3.0/platform/devices/MKL26Z4/startup/system_MKL26Z4.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross ARM C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -Wall  -g -DDEBUG -DCPU_MKL26Z128VLH4 -DFRDM_KL26Z -DFREEDOM -I../../../../../../platform/osa/inc -I../../../../../../platform/utilities/inc -I../../../../../../platform/CMSIS/Include -I../../../../../../platform/devices -I../../../../../../platform/devices/MKL26Z4/include -I../../../../../../platform/devices/MKL26Z4/startup -I../../../../../../platform/hal/inc -I../../../../../../platform/drivers/inc -I../../../../../../platform/system/inc -I../../../../../../platform/drivers/src/i2c -I../.. -I../../../.. -std=gnu99 -fno-common  -ffreestanding  -fno-builtin  -mapcs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
